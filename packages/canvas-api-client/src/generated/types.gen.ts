...
export type GetSingleCourseAccountsData = {
    ...
    query?: {
         ...
         */
        include?: 'needs_grading_count' | 'syllabus_body' | 'public_description' | 'total_scores' | 'current_grading_period_scores' | 'term' | 'account' | 'course_progress' | 'sections' | 'storage_quota_used_mb' | 'total_students' | 'passback_status' | 'favorites' | 'teachers' | 'observed_users' | 'all_courses' | 'permissions' | 'course_image';
    };
...
export type ListYourCoursesData = {
    ...
    query?: {
         ...
         * and the course image feature flag has been enabled
         */
        include?: 'needs_grading_count' | 'syllabus_body' | 'public_description' | 'total_scores' | 'current_grading_period_scores' | 'term' | 'account' | 'course_progress' | 'sections' | 'storage_quota_used_mb' | 'total_students' | 'passback_status' | 'favorites' | 'teachers' | 'observed_users' | 'course_image';
        /**
...
export type ListAssignmentGroupsData = {
    ...
    query?: {
         ...
         */
        include?: 'assignments' | 'discussion_topic' | 'all_dates' | 'assignment_visibility' | 'overrides' | 'submission';
        /**
         * If "assignments" are included, those with the specified submission types
         * will be excluded from the assignment groups.
         */
        exclude_assignment_submission_types?: 'online_quiz' | 'discussion_topic' | 'wiki_page' | 'external_tool';
        /**
...
export type GetAssignmentGroupData = {
    ...
    query?: {
         ...
         */
        include?: 'assignments' | 'discussion_topic' | 'assignment_visibility' | 'submission';
        /**
         * Apply assignment overrides for each assignment, defaults to true.
         */
        override_assignment_dates?: boolean;
...
export type CreateAssignmentData = {
    body: {
        ...
        'assignment[submission_types]'?: 'online_quiz' | 'none' | 'on_paper' | 'discussion_topic' | 'external_tool' | 'online_upload' | 'online_text_entry' | 'online_url' | 'media_recording';
        /**
...
export type ListAssignmentSubmissionsCoursesData = {
    ...
    query?: {
         ...
         */
        include?: 'submission_history' | 'submission_comments' | 'rubric_assessment' | 'assignment' | 'visibility' | 'course' | 'user' | 'group';
        /**
...
export type GetSingleSubmissionCoursesData = {
    ...
    query?: {
         ...
         */
        include?: 'submission_history' | 'submission_comments' | 'rubric_assessment' | 'visibility' | 'course' | 'user';
    };
...
export type CopyCourseContentData = {
    body?: {
         ...
         * be copied.
         */
        except?: 'course_settings' | 'assignments' | 'external_tools' | 'files' | 'topics' | 'calendar_events' | 'quizzes' | 'wiki_pages' | 'modules' | 'outcomes';
        /**
         * A list of the course content types to copy, all areas not listed will not
         * be copied.
         */
        only?: 'course_settings' | 'assignments' | 'external_tools' | 'files' | 'topics' | 'calendar_events' | 'quizzes' | 'wiki_pages' | 'modules' | 'outcomes';
        /**
...
export type ListEnrollmentsCoursesData = {
    ...
    query?: {
         ...
         */
        include?: 'avatar_url' | 'group_ids' | 'locked' | 'observed_users' | 'can_be_removed';
        /**
...
export type ListUsersInCourseSearchUsersData = {
    ...
    query?: {
         ...
         */
        include?: 'email' | 'enrollments' | 'locked' | 'avatar_url' | 'test_student' | 'bio' | 'custom_links' | 'current_grading_period_scores';
        /**
...
export type ListCourseSectionsData = {
    ...
    query?: {
         ...
         */
        include?: 'students' | 'avatar_url' | 'enrollments' | 'total_students' | 'passback_status';
        /**
         * The bookmark leading to the next paginated page. This needs to be parsed from the response header ('Link' field).
         */
        page?: string;
...
export type ListSubmissionsForMultipleAssignmentsCoursesData = {
    ...
    query?: {
         ...
         * `grouped` argument.
         */
        'include[]'?: 'submission_history' | 'submission_comments' | 'rubric_assessment' | 'assignment' | 'total_scores' | 'visibility' | 'course' | 'user';
        /**
         * The bookmark leading to the next paginated page. This needs to be parsed from the response header ('Link' field).
         */
        page?: string;
...
export type ListGroupMembershipsData = {
    ...
    query?: {
         ...
         */
        filter_states?: 'accepted' | 'invited' | 'requested';
        /**
         * The bookmark leading to the next paginated page. This needs to be parsed from the response header ('Link' field).
         */
        page?: string;
...
export type ClientOptions = {
    baseUrl: 'https://gitlab.com' | (string & {});
};