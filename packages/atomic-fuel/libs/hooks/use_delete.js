...
function useDelete(timeout) {
    ...
    var deleteIt = function (url_1) {
        var args_1 = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args_1[_i - 1] = arguments[_i];
        }
        return __awaiter(_this, __spreadArray([url_1], args_1, true), void 0, function (url, params, headers) {
            var res, err_1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        setLoading(true);
                        return [4 /*yield*/, api_1.default.del(url, settings.api_url, jwt, settings.csrf_token, params, headers, timeout)];
                    case 1:
                        res = _a.sent();
                        setResult(res);
                        return [3 /*break*/, 3];
...
//# sourceMappingURL=use_delete.js.map