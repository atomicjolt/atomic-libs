...
When used within a TooltipTrigger this is set automatically. It is only required when used standalone.`,name:"triggerRef",required:!1,type:{name:"RefObject<Element>"}},placement:{defaultValue:null,description:"The placement of the element with respect to its anchor element.",name:"placement",required:!1,type:{name:"enum",value:[{value:'"bottom"'},{value:'"top"'},{value:'"left"'},{value:'"right"'}]}},transitionDuration:{defaultValue:null,description:"",name:"transitionDuration",required:!1,type:{name:"number"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"RenderClassName<never>"}},style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"RenderStyle<never>"}}}}}catch{}function H(n){const{delay:i=0,closeDelay:s=0,...a}=n,r=Ie({delay:i,closeDelay:s,...a}),e=f.useRef(null),{triggerProps:t,tooltipProps:o}=je(n,r,e);return u.jsx(Se,{values:[[ue.Provider,r],[ce.Provider,{...o,triggerRef:e}]],children:u.jsx(_e,{...t,ref:e,children:n.children})})}try{H.displayName="ToolTipTrigger",H.__docgenInfo={description:"",displayName:"ToolTipTrigger",props:{className:{defaultValue:null,description:`Add classes to the root element of the component.
