...
When an item in the menu is selected, an associated action is performed`,displayName:"Menu",props:{style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"RenderStyle<never> | undefined"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"RenderClassName<never>"}}}}}catch{}export{v as M,Xe as a};
