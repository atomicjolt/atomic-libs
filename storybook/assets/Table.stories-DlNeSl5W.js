...
}`,...(X=(U=u.parameters)==null?void 0:U.docs)==null?void 0:X.source}}};const oe=["Primary","MultipleSelection","SingleSelection","SortableHeaders","SearchableColumns","LoadingState","TableSkeleton","RenderEmptyTable","WithTableBottom","WithPagination","StickyRowHeader"],we=Object.freeze(Object.defineProperty({__proto__:null,LoadingState:C,MultipleSelection:i,Primary:n,RenderEmptyTable:h,SearchableColumns:d,SingleSelection:t,SortableHeaders:c,StickyRowHeader:u,TableSkeleton:b,WithPagination:m,WithTableBottom:T,__namedExportsOrder:oe,default:se},Symbol.toStringTag,{value:"Module"}));export{C as L,i as M,c as S,we as T,T as W,d as a,t as b,b as c};
