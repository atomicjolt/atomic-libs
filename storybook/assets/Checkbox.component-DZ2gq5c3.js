import{j as d}from"./jsx-runtime-D_zvdyIk.js";import{r as C,R as P}from"./index-DmM0KDA7.js";import{b as I}from"./useObjectRef-BO7mrmvR.js";import{$ as S,a as V}from"./useFormValidationState-CKAS44yz.js";import{$ as B}from"./useFormValidation-CsrNRCZi.js";import{$ as D}from"./usePress-Cxy0og0d.js";import{$ as j,a as w}from"./useToggle-m3163Lci.js";import{$ as E}from"./context-BF7eBGFA.js";import{H as z}from"./Inputs.styles-DPN4cDPp.js";import{d as y}from"./styled-components.browser.esm-B0S50oBn.js";import{m as k}from"./mixins-CgZ-Dp8B.js";import{d as x}from"./utils-DqmNl-Il.js";import{c as N,u as _}from"./index-CqJC2f1M.js";import{R as O}from"./RequiredMarker-CwAzCIB3.js";import{u as F}from"./useRenderProps-BzxgHqRb.js";import{M}from"./Message.component-CufFXYCC.js";import{E as H}from"./ErrorMessage.component-CS4OzHGN.js";function L(e,r,t){let i=S({...e,value:r.isSelected}),{isInvalid:o,validationErrors:s,validationDetails:l}=i.displayValidation,{labelProps:m,inputProps:f,isSelected:b,isPressed:n,isDisabled:c,isReadOnly:h}=j({...e,isInvalid:o},r,t);B(e,i,t);let{isIndeterminate:$,isRequired:p,validationBehavior:u="aria"}=e;C.useEffect(()=>{t.current&&(t.current.indeterminate=!!$)});let{pressProps:R}=D({isDisabled:c||h,onPress(){let{[V]:v}=e,{commitValidation:q}=v||i;q()}});return{labelProps:I(m,R),inputProps:{...f,checked:b,"aria-required":p&&u==="aria"||void 0,required:p&&u==="native"},isSelected:b,isPressed:n,isDisabled:c,isReadOnly:h,isInvalid:o,validationErrors:s,validationDetails:l}}const a=y.span`
  ${k.Regular}
...
`,A=N(),g=P.forwardRef((e,r)=>{[e,r]=_(A,e,r);const{error:t="error",message:i,isRequired:o=!1,isInvalid:s=!1,isIndeterminate:l=!1,isReadOnly:m=!1,isDisabled:f=!1,name:b}=e,n=w(e),{direction:c}=E(),{inputProps:h,labelProps:$}=L({...e,children:!0},n,r),p=F({componentClassName:"aje-checkbox",values:{isSelected:n.isSelected,isIndeterminate:l,isInvalid:s,isDisabled:f,isReadOnly:m,isRequired:o},selectors:{"data-selected":n.isSelected,"data-indeterminate":l,"data-invalid":s,"data-disabled":f,"data-readonly":m,"data-required":o},...e}),u=l?"mixed":void 0;return d.jsxs(U,{$rtl:c==="rtl",...p,children:[d.jsx(z,{...h,ref:r,"aria-checked":u,name:b}),d.jsxs(a,{...$,$rtl:c==="rtl",children:[p.children,o&&d.jsx(O,{}),i&&d.jsx(M,{children:i}),s&&d.jsx(H,{isInvalid:!0,children:t})]})]})});try{g.displayName="CheckBox",g.__docgenInfo={description:"Checkbox Component. Accepts a `ref`",displayName:"CheckBox",props:{name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}},error:{defaultValue:null,description:"Error message for the field",name:"error",required:!1,type:{name:"ReactNode"}},message:{defaultValue:null,description:"For additional information (ex. date format mm/dd/yy)",name:"message",required:!1,type:{name:"ReactNode"}},isDisabled:{defaultValue:null,description:`Field cannot be interacted with, should be de-emphasized in the UI
