import{j as b}from"./jsx-runtime-D_zvdyIk.js";import{r as f}from"./index-DmM0KDA7.js";import{a as y,b as j}from"./useObjectRef-BO7mrmvR.js";import{u as P}from"./useFocusRing-4PdL76fJ.js";import{u as $}from"./useRenderProps-BzxgHqRb.js";import{$ as B}from"./useButton-DlM8S39G.js";import{$ as z}from"./useLink-CqmZ9M1P.js";import{c as V,u as w}from"./index-CqJC2f1M.js";import{d as L}from"./styled-components.browser.esm-B0S50oBn.js";import{m as l}from"./mixins-CgZ-Dp8B.js";import{S as k}from"./SpinnerLoader.component-BwJ7Xb9x.js";function C(r,e){const{buttonProps:n,isPressed:a}=B(r,e),{linkProps:t,isPressed:o}=z(r,e);return r.elementType==="a"?{buttonProps:t,isPressed:o}:{buttonProps:n,isPressed:a}}const q=L.button`
  ${l.SizingX}
  ${l.Bold}
  ${l.FocusVisible(2)}
