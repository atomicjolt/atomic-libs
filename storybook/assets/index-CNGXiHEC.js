import{j as d}from"./jsx-runtime-D_zvdyIk.js";import{r as C,R as V}from"./index-DmM0KDA7.js";import{a as I}from"./useObjectRef-BMBYa31u.js";import{$ as P,a as S}from"./useFormValidationState-CKAS44yz.js";import{$ as B}from"./useFormValidation-Dk9gOIEC.js";import{$ as _}from"./usePress-BejIIMCm.js";import{$ as N,a as w}from"./useToggle-DUU44cvO.js";import{$ as D}from"./context-BF7eBGFA.js";import{H as E}from"./Inputs.styles-D7Jp_X1z.js";import{d as g}from"./styled-components.browser.esm-B0S50oBn.js";import{m as y}from"./mixins-CgZ-Dp8B.js";import{d as x}from"./utils-DqmNl-Il.js";import{c as F,u as j}from"./index-9MQGFWEg.js";import{u as z}from"./useRenderProps-BzxgHqRb.js";import{R as O}from"./RequiredMarker-CwAzCIB3.js";import{M}from"./Message.component-BDMPukxI.js";import{E as U}from"./ErrorMessage.component-SZdxpdif.js";function A(e,r,i){let t=P({...e,value:r.isSelected}),{isInvalid:o,validationErrors:l,validationDetails:s}=t.displayValidation,{labelProps:p,inputProps:u,isSelected:f,isPressed:n,isDisabled:c,isReadOnly:b}=N({...e,isInvalid:o},r,i);B(e,t,i);let{isIndeterminate:k,isRequired:m,validationBehavior:h="aria"}=e;C.useEffect(()=>{i.current&&(i.current.indeterminate=!!k)});let{pressProps:R}=_({isDisabled:c||b,onPress(){let{[S]:$}=e,{commitValidation:q}=$||t;q()}});return{labelProps:I(p,R),inputProps:{...u,checked:f,"aria-required":m&&h==="aria"||void 0,required:m&&h==="native"},isSelected:f,isPressed:n,isDisabled:c,isReadOnly:b,isInvalid:o,validationErrors:l,validationDetails:s}}const a=g.span`
  ${y.Regular}
