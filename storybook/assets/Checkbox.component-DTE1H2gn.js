import{j as i}from"./jsx-runtime-CkxqCPlQ.js";import{r as v,R as k}from"./index-DJO9vBfz.js";import{c as y}from"./index-i5X67GZP.js";import{$}from"./useFormValidation-B89CjNwR.js";import{$ as g}from"./useFormValidationState-Cu8bp2uX.js";import{$ as _,a as q}from"./useToggle-F9_xYzmQ.js";import{$ as C}from"./context-CKyfYUWk.js";import{b as I,c as j,C as R}from"./Inputs.styles-D8K_qOL9.js";import{d as P}from"./styled-components.browser.esm-WCay-hu9.js";import{c as V,u as N}from"./index-CXdyvu6V.js";import{M as D}from"./Message.component-DgHLwaZZ.js";import{E}from"./ErrorMessage.component-DYIqQ3G7.js";function S(e,a,r){let o=g({...e,value:a.isSelected}),{isInvalid:t,validationErrors:m,validationDetails:s}=o.displayValidation,{labelProps:l,inputProps:p,isSelected:d,isPressed:h,isDisabled:f,isReadOnly:b}=_({...e,isInvalid:t},a,r);$(e,o,r);let{isIndeterminate:n,isRequired:c,validationBehavior:u="aria"}=e;return v.useEffect(()=>{r.current&&(r.current.indeterminate=!!n)}),{labelProps:l,inputProps:{...p,checked:d,"aria-required":c&&u==="aria"||void 0,required:c&&u==="native"},isSelected:d,isPressed:h,isDisabled:f,isReadOnly:b,isInvalid:t,validationErrors:m,validationDetails:s}}const w=P(I)`
...
@selector [data-readonly]`,name:"isReadOnly",required:!1,type:{name:"boolean"}},name:{defaultValue:null,description:"Name of the Field",name:"name",required:!1,type:{name:"string"}},message:{defaultValue:null,description:"For additional information (ex. date format mm/dd/yy)",name:"message",required:!1,type:{name:"ReactNode"}}}}}catch{}export{x as C,B as a};
