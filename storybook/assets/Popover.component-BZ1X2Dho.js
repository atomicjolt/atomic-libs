import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{R as h,r as $}from"./index-BCtMShv3.js";import{$ as ie}from"./useLabels-BQTM_NWA.js";import{$ as de}from"./useLocalizedStringFormatter-BmC8c4z2.js";import{$ as ne}from"./VisuallyHidden-DMkWAsdD.js";import{$ as pe,a as ue,c as ce,b as le,O as fe}from"./context-BGWN95Kf.js";import{$ as me}from"./useOverlayPosition-CwzQS3_v.js";import{c as $e,a as C}from"./useObjectRef-B4hnndUj.js";import{$ as ve,b as be}from"./useOverlayTriggerState-B3l5rho6.js";import{f as xe}from"./CollectionBuilder-L_wKxqRd.js";import{u as he}from"./useRenderProps-CP918x9p.js";import{u as ge}from"./index-C_lK3xe_.js";import{u as ye}from"./useForwardedRef-DuXBQIpF.js";import{E as Pe,g as O}from"./styled-components.browser.esm-DC3GK9Rn.js";import{P as Ce}from"./Popover.context-wYAB1U4T.js";var R={};R={dismiss:"تجاهل"};var D={};D={dismiss:"Отхвърляне"};var w={};w={dismiss:"Odstranit"};var E={};E={dismiss:"Luk"};var j={};j={dismiss:"Schließen"};var S={};S={dismiss:"Απόρριψη"};var N={};N={dismiss:"Dismiss"};var A={};A={dismiss:"Descartar"};var k={};k={dismiss:"Lõpeta"};var I={};I={dismiss:"Hylkää"};var B={};B={dismiss:"Rejeter"};var L={};L={dismiss:"התעלם"};var T={};T={dismiss:"Odbaci"};var F={};F={dismiss:"Elutasítás"};var K={};K={dismiss:"Ignora"};var H={};H={dismiss:"閉じる"};var V={};V={dismiss:"무시"};var W={};W={dismiss:"Atmesti"};var q={};q={dismiss:"Nerādīt"};var M={};M={dismiss:"Lukk"};var U={};U={dismiss:"Negeren"};var z={};z={dismiss:"Zignoruj"};var Z={};Z={dismiss:"Descartar"};var G={};G={dismiss:"Dispensar"};var Y={};Y={dismiss:"Revocare"};var _={};_={dismiss:"Пропустить"};var J={};J={dismiss:"Zrušiť"};var Q={};Q={dismiss:"Opusti"};var X={};X={dismiss:"Odbaci"};var ee={};ee={dismiss:"Avvisa"};var re={};re={dismiss:"Kapat"};var se={};se={dismiss:"Скасувати"};var oe={};oe={dismiss:"取消"};var te={};te={dismiss:"關閉"};var ae={};ae={"ar-AE":R,"bg-BG":D,"cs-CZ":w,"da-DK":E,"de-DE":j,"el-GR":S,"en-US":N,"es-ES":A,"et-EE":k,"fi-FI":I,"fr-FR":B,"he-IL":L,"hr-HR":T,"hu-HU":F,"it-IT":K,"ja-JP":H,"ko-KR":V,"lt-LT":W,"lv-LV":q,"nb-NO":M,"nl-NL":U,"pl-PL":z,"pt-BR":Z,"pt-PT":G,"ro-RO":Y,"ru-RU":_,"sk-SK":J,"sl-SI":Q,"sr-SP":X,"sv-SE":ee,"tr-TR":re,"uk-UA":se,"zh-CN":oe,"zh-TW":te};function Oe(e){return e&&e.__esModule?e.default:e}function y(e){let{onDismiss:s,...a}=e,o=de(Oe(ae),"@react-aria/overlays"),r=ie(a,o.format("dismiss")),t=()=>{s&&s()};return h.createElement(ne,null,h.createElement("button",{...r,tabIndex:-1,onClick:t,style:{width:1,height:1}}))}function Re(e,s){let{triggerRef:a,popoverRef:o,groupRef:r,isNonModal:t,isKeyboardDismissDisabled:i,shouldCloseOnInteractOutside:p,...u}=e,c=u.trigger==="SubmenuTrigger",{overlayProps:v,underlayProps:b}=pe({isOpen:s.isOpen,onClose:s.close,shouldCloseOnBlur:!0,isDismissable:!t||c,isKeyboardDismissDisabled:i,shouldCloseOnInteractOutside:p},r??o),{overlayProps:m,arrowProps:x,placement:l}=me({...u,targetRef:a,overlayRef:o,isOpen:s.isOpen,onClose:t&&!c?s.close:null});return ue({isDisabled:t||!s.isOpen}),$e(()=>{if(s.isOpen&&o.current){var f,d;return t?ce((f=r==null?void 0:r.current)!==null&&f!==void 0?f:o.current):le([(d=r==null?void 0:r.current)!==null&&d!==void 0?d:o.current])}},[t,s.isOpen,o,r]),{popoverProps:C(v,m),arrowProps:x,underlayProps:b,placement:l}}function De(e,s,a={}){$.useLayoutEffect(()=>{if(!e||!window.ResizeObserver)return;const o=new ResizeObserver(s);return o.observe(e,a),()=>o.disconnect()},[e,s,a.box])}const we=Pe`
  from {
