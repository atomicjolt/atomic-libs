...
}`,...(x=(g=l.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};var f,E,B;u.parameters={...u.parameters,docs:{...(f=u.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => {
    const [shouldThrow, setShouldThrow] = useState(false);
    return <div>
        <Button onPress={() => setShouldThrow(!shouldThrow)} variant={shouldThrow ? "success" : "error"}>
...
}`,...(B=(E=u.parameters)==null?void 0:E.docs)==null?void 0:B.source}}};var v,b,w;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => {
...
}`,...(k=(j=h.parameters)==null?void 0:j.docs)==null?void 0:k.source}}};const jr=["WithStaticFallback","WithFunctionFallback","WithResetKeys","NestedErrorBoundaries"];export{h as NestedErrorBoundaries,u as WithFunctionFallback,c as WithResetKeys,l as WithStaticFallback,jr as __namedExportsOrder,Cr as default};
