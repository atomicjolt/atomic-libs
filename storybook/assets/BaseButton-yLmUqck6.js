import{d as y}from"./styled-components.browser.esm-Y4FpNNpy.js";import{m as l}from"./mixins-XviowZ_6.js";import{j as b}from"./jsx-runtime-D_zvdyIk.js";import{r as j}from"./index-BCtMShv3.js";import{a as B,b as $}from"./useObjectRef-D2RG7rRi.js";import{u as w}from"./useFocusRing-88kjlAJd.js";import{$ as P}from"./useButton-DYDUZLxM.js";import{$ as z}from"./useLink-D8UViwUR.js";import{u as V}from"./useRenderProps-CP918x9p.js";import{S as k}from"./SpinnerLoader.component-Txom5Uuv.js";const W=y.button`
  ${l.SizingX}
  ${l.Bold}
  ${l.FocusVisible(2)}
...
`;function L(r,e){const{buttonProps:a,isPressed:n}=P(r,e),{linkProps:o,isPressed:t}=z(r,e);return r.elementType==="a"?{buttonProps:o,isPressed:t}:{buttonProps:a,isPressed:n}}const d=j.forwardRef(function(e,a){const n=B(a),{Component:o,isLoading:t=!1,loadingLabel:u,loadingComplete:v=!1,as:s=e.href?"a":"button",variant:p="primary",size:m="auto"}=e,{buttonProps:g,isPressed:i}=L({...e,elementType:s,"aria-label":t?u:e["aria-label"]},n),{focusProps:x,isFocusVisible:f,isFocused:h}=w(),c=V({componentClassName:"aje-btn",...e,variant:p,size:m,values:{isPressed:i,isLoading:t,isFocusVisible:f,isFocused:h},selectors:{"data-pressed":i,"data-loading":t}});return b.jsxs(o,{as:s,ref:n,...$(g,x,c),children:[t&&b.jsx(k,{isLoading:!v,placement:"absolute center","aria-label":"loading"}),c.children]})});try{d.displayName="BaseButton",d.__docgenInfo={description:"BaseButton component - a foundational button component that can be extended for various button types",displayName:"BaseButton",props:{Component:{defaultValue:null,description:"",name:"Component",required:!0,type:{name:"ElementType<any, keyof IntrinsicElements>"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"enum",value:[{value:'"button"'},{value:'"a"'}]}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"medium"'},{value:'"large"'},{value:'"auto"'},{value:'"full"'}]}},isLoading:{defaultValue:null,description:`When loading is true, the content will be replaced with a spinner.
