import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as h}from"./index-DmM0KDA7.js";import{P as v}from"./index-DlO4Jvyt.js";import{L as b}from"./index-CQoer24W.js";import{F as g}from"./FloatingFieldInputWrapper-BYUYsVjJ.js";import{d as o}from"./styled-components.browser.esm-S-CusIP4.js";import{m as y}from"./mixins-BOHXBJW9.js";import{F as x}from"./Dropdowns.styles-c5wm-1S0.js";import{S as l}from"./SelectField.component-CfP0305I.js";import{u as q}from"./useRenderProps-BzxgHqRb.js";const w=o(l)`
  &.aje-select--floating {
    ${x}
  }
`;o.input`
...
@selector [data-required]`,name:"isRequired",required:!1,type:{name:"boolean"}},isInvalid:{defaultValue:null,description:"Field has an error. Should be made to look like an error.\nControls whether the value of `error` is displayed\n@selector [data-invalid]",name:"isInvalid",required:!1,type:{name:"boolean"}},name:{defaultValue:null,description:"Name of the Field",name:"name",required:!1,type:{name:"string"}},variant:{defaultValue:null,description:"",name:"variant",required:!1,type:{name:"SuggestStrings<CustomSelectVariants>"}},maxHeight:{defaultValue:{value:"height of the viewport"},description:"The maximum height of the the dropdown.",name:"maxHeight",required:!1,type:{name:"number"}},dropdownPlacement:{defaultValue:null,description:"",name:"dropdownPlacement",required:!1,type:{name:"enum",value:[{value:'"start"'},{value:'"left"'},{value:'"right"'},{value:'"end"'},{value:'"bottom"'},{value:'"bottom left"'},{value:'"bottom right"'},{value:'"bottom start"'},{value:'"bottom end"'},{value:'"top"'},{value:'"top left"'},{value:'"top right"'},{value:'"top start"'},{value:'"top end"'},{value:'"left top"'},{value:'"left bottom"'},{value:'"start top"'},{value:'"start bottom"'},{value:'"right top"'},{value:'"right bottom"'},{value:'"end top"'},{value:'"end bottom"'}]}}}}}catch{}export{r as C};
