import{j as d}from"./jsx-runtime-D_zvdyIk.js";import{r as C,R as P}from"./index-DmM0KDA7.js";import{b as I}from"./useObjectRef-BO7mrmvR.js";import{$ as S,a as V}from"./useFormValidationState-CKAS44yz.js";import{$ as B}from"./useFormValidation-CsrNRCZi.js";import{$ as D}from"./usePress-Cxy0og0d.js";import{$ as j,a as w}from"./useToggle-m3163Lci.js";import{$ as E}from"./context-BF7eBGFA.js";import{H as z}from"./Inputs.styles-k0ruc26M.js";import{d as y}from"./styled-components.browser.esm-B0S50oBn.js";import{m as k}from"./mixins-CgZ-Dp8B.js";import{d as x}from"./utils-DqmNl-Il.js";import{c as N,u as _}from"./index-CqJC2f1M.js";import{u as O}from"./useRenderProps-BzxgHqRb.js";import{R as F}from"./RequiredMarker-CwAzCIB3.js";import{M}from"./Message.component-C_idOZHk.js";import{E as H}from"./ErrorMessage.component-yVGc6EDx.js";function L(e,r,t){let i=S({...e,value:r.isSelected}),{isInvalid:o,validationErrors:s,validationDetails:l}=i.displayValidation,{labelProps:m,inputProps:f,isSelected:b,isPressed:n,isDisabled:c,isReadOnly:h}=j({...e,isInvalid:o},r,t);B(e,i,t);let{isIndeterminate:$,isRequired:p,validationBehavior:u="aria"}=e;C.useEffect(()=>{t.current&&(t.current.indeterminate=!!$)});let{pressProps:R}=D({isDisabled:c||h,onPress(){let{[V]:v}=e,{commitValidation:q}=v||i;q()}});return{labelProps:I(m,R),inputProps:{...f,checked:b,"aria-required":p&&u==="aria"||void 0,required:p&&u==="native"},isSelected:b,isPressed:n,isDisabled:c,isReadOnly:h,isInvalid:o,validationErrors:s,validationDetails:l}}const a=y.span`
  ${k.Regular}
