import{j as d}from"./jsx-runtime-D_zvdyIk.js";import{r as C,R as V}from"./index-BCtMShv3.js";import{b as I}from"./useObjectRef-D2RG7rRi.js";import{$ as P,a as S}from"./useFormValidationState-CONlS5Wo.js";import{$ as B}from"./useFormValidation-BfT1egZx.js";import{$ as _}from"./usePress-B9aiz4Kw.js";import{$ as N,a as w}from"./useToggle-CLxvcIRx.js";import{$ as D}from"./context-z6pb9OkM.js";import{H as E}from"./Inputs.styles-DLBKMeQO.js";import{d as g}from"./styled-components.browser.esm-Y4FpNNpy.js";import{m as y}from"./mixins-XviowZ_6.js";import{d as x}from"./utils-DqmNl-Il.js";import{c as F,u as j}from"./index-CsiUWFDz.js";import{u as z}from"./useRenderProps-CP918x9p.js";import{R as O}from"./RequiredMarker-CwAzCIB3.js";import{M}from"./Message.component-FuO2yEmk.js";import{E as U}from"./ErrorMessage.component-ukBp7bMH.js";function A(e,r,i){let t=P({...e,value:r.isSelected}),{isInvalid:o,validationErrors:l,validationDetails:s}=t.displayValidation,{labelProps:p,inputProps:u,isSelected:f,isPressed:n,isDisabled:c,isReadOnly:b}=N({...e,isInvalid:o},r,i);B(e,t,i);let{isIndeterminate:k,isRequired:m,validationBehavior:h="aria"}=e;C.useEffect(()=>{i.current&&(i.current.indeterminate=!!k)});let{pressProps:R}=_({isDisabled:c||b,onPress(){let{[S]:$}=e,{commitValidation:q}=$||t;q()}});return{labelProps:I(p,R),inputProps:{...u,checked:f,"aria-required":m&&h==="aria"||void 0,required:m&&h==="native"},isSelected:f,isPressed:n,isDisabled:c,isReadOnly:b,isInvalid:o,validationErrors:l,validationDetails:s}}const a=g.span`
  ${y.Regular}
