import{j as a}from"./jsx-runtime-CkxqCPlQ.js";import{$ as f}from"./filterDOMProps-CeZl_uWj.js";import"./index-CyCRagT9.js";import{u as y}from"./useRenderProps-Bk8BH60l.js";import{d}from"./styled-components.browser.esm-BQf_XqKi.js";import{m as c}from"./mixins-B7X2BZyR.js";import{F as h}from"./Flex.component-DqBL6Xjb.js";import{C as g}from"./Checkmark.component-uYKMesek.js";const b=d.div`
  ${c.Sizing}
  --size-sm-x: 12px;
  --size-md-x: 16px;
  --size-lg-x: 30px;
...
`,x=d.p`
  ...
  font-size: inherit;
  color: var(--text-clr);
`;function o(e){const{isLoading:i=!0,placement:l="center",orientation:m="vertical",size:t="medium",message:r}=e,u=["inline","block"].includes(l)?"inline":"center",n=y({componentClassName:"aje-loader",...e,size:t,values:{isLoading:i}}),s=m==="horizontal"?"row":"column",p=f(e);return a.jsx(b,{...n,...p,"data-placement":l,children:i?a.jsxs(h,{$display:u==="inline"?"inline-flex":"flex",$direction:s,$gap:s==="row"?"1rem":"0",$justify:"center",$align:"center",children:[n.children,r&&a.jsx(x,{children:r})]}):typeof e.children=="function"?n.children:a.jsx(g,{size:t})})}try{o.displayName="Loader",o.__docgenInfo={description:`Loader component. Manages the placement
