...
`,v=g.forwardRef(function(t,o){return[t,o]=Te(Xe,t,o),u.jsx(_e,{content:u.jsx(De,{...t}),children:r=>r.size>0&&u.jsx(to,{...t,collection:r,menuRef:o})})});v.displayName="Menu";function to(e){const{menuRef:t,className:o}=e,r=Oe(e),n=W(t),{menuProps:d}=Ge(e,r,n),{CollectionRenderer:l}=L();return u.jsx(Ye,{ref:n,className:xe("aje-menu",o),...d,...E(e),children:u.jsx(Ee,{values:[[U.Provider,r],[ze.Provider,{render:J}],[He.Provider,{render:X}]],children:u.jsx(l,{collection:e.collection})})})}function J(e,t,o){const r=g.useContext(U),{CollectionBranchRenderer:n}=L(),{itemProps:d,headingProps:l,groupProps:s}=Qe({heading:e.title,"aria-label":o["aria-label"]}),i=O({componentClassName:"aje-menu__section",...e,children:e.title});return u.jsxs(u.Fragment,{children:[o.key!==r.collection.getFirstKey()&&u.jsx(We,{as:"li"}),u.jsxs("li",{...d,...i,ref:t,children:[i.children&&u.jsx(eo,{...l,children:i.children}),u.jsx(Ze,{...s,children:u.jsx(n,{collection:r.collection,parent:o})})]})]})}const Q=je("section",J);Q.displayName="Menu.Section";v.Section=Q;const X=(e,t,o)=>{const r=g.useContext(U),n=W(t),{menuItemProps:d,isSelected:l}=Je({key:o.key,"aria-label":e["aria-label"]},r,n),{focusProps:s,isFocused:i,isFocusVisible:b}=Ae(),p=O({componentClassName:"aje-menu__item",...e,children:o.rendered,values:{isSelected:l,isFocused:i,isFocusVisible:b}});return u.jsx(oo,{...I(d,s),...p,as:e.href?"a":"li",ref:n,children:p.children})},Y=Ie("item",X);Y.displayName="Menu.Item";v.Item=Y;try{v.displayName="Menu",v.__docgenInfo={description:`A Menu is a collection of items that the user can select.
When an item in the menu is selected, an associated action is performed`,displayName:"Menu",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"RenderClassName<never>"}},style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"RenderStyle<never> | undefined"}}}}}catch{}export{v as M,Xe as a};
