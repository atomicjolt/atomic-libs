import{j as t}from"./jsx-runtime-CkxqCPlQ.js";import{F as X,R as Y}from"./helpers-fQWfWkgV.js";import{g as Z}from"./cssprops-BTVAmD30.js";import{a as y,d as ee}from"./useObjectRef-CjtaasUj.js";import{$ as z}from"./filterDOMProps-CeZl_uWj.js";import{$ as ae}from"./FocusScope-D8kX7o4N.js";import{$ as re}from"./useField-c4_Ph5j6.js";import{$ as ie}from"./useFocusWithin-BwiFBvMF.js";import{$ as A}from"./context-BQ3_Es2z.js";import{r as P,R as oe}from"./index-DJO9vBfz.js";import{d as C}from"./styled-components.browser.esm-BQf_XqKi.js";import{m as S}from"./mixins-D6ZuOvce.js";import{d as O}from"./utils-2VFVy79V.js";import{u as H}from"./useRenderProps-Bk8BH60l.js";import{R as te}from"./RequiredMarker-DVRabd4Z.js";import{$ as le}from"./useFormValidationState-DFldk10H.js";import{$ as se}from"./useControlledState-CN8sBTKq.js";import{L as de}from"./Label.component-BZ-jUZHh.js";import{M as U}from"./Message.component-DWiHyL-P.js";import{E as K}from"./ErrorMessage.component-DPAek6pW.js";import{$ as ne}from"./useFormReset-Bq2IuLnF.js";import{$ as ce}from"./useFocusable-CRaVIClu.js";import{$ as pe}from"./useFormValidation-CkGNgIJp.js";import{$ as L}from"./usePress-DOH0gK78.js";import{H as ue}from"./Inputs.styles-OWeL2ZqS.js";import"./layout-qoR695S7.js";import"./Collection-DjPHrlSR.js";import"./CollectionBuilder-JuF9vAdV.js";import"./index-DJdX7xnk.js";import"./SSRProvider-DAMUgb6s.js";import"./index-Co2NqHf1.js";import"./focusSafely-f-NvfehK.js";import"./useLabel-7v3RoPQd.js";import"./useLabels-DvZR7g99.js";import"./utils-Bz-oJdcG.js";import"./index-i5X67GZP.js";import"./Label.context-BBG6Xa_C.js";import"./Message.context-DZr9m1_6.js";import"./ErrorMessage.context-Buhm2lRy.js";import"./useFocus-zOn8SIU-.js";import"./useKeyboard-A8_doyNT.js";import"./ComboInput.styles-BpY8b9Fd.js";import"./TextField.component-C9IwLSWi.js";import"./useTextField-Fhkucs1k.js";import"./Field.styles-CsRBBplX.js";import"./Provider-B9Eqn13H.js";import"./ComboInput.context-ocWXhSuv.js";import"./Input.context-Bkm7QTcU.js";import"./NumberField.component-D2hNFcer.js";import"./useEvent-CWl__ymk.js";import"./useLocalizedStringFormatter-DBaQHtvd.js";import"./useNumberFormatter-D5qg7lg6.js";import"./NumberFormatter-DNR9MAW-.js";import"./useSpinButton-DOEyhSS3.js";import"./LiveAnnouncer-CeCcBDbP.js";import"./number-nHrFdSb-.js";import"./IconButton.component-Dg_s0u7A.js";import"./Button.component-DtbpFVXN.js";import"./useFocusRing-CkPe2VLa.js";import"./useButton-CK1XMKNi.js";import"./useLink-Bis7wRJn.js";import"./SpinnerLoader.component-CZS0l4HJ.js";import"./Loader.component-DTNPwaWm.js";import"./Flex.component-BqyhhyXT.js";import"./Checkmark.component-DV3x2bJU.js";import"./Spinner.component-LKZLOMLe.js";import"./MaterialIcon.component-Bb94pzqW.js";import"./Icons.styles-BaNpbbIh.js";let me=Math.round(Math.random()*1e10),fe=0;function be(e){let a=P.useMemo(()=>e.name||`radio-group-${me}-${++fe}`,[e.name]);var l;let[o,r]=se(e.value,(l=e.defaultValue)!==null&&l!==void 0?l:null,e.onChange),[m,c]=P.useState(null),i=le({...e,value:o}),p=h=>{!e.isReadOnly&&!e.isDisabled&&(r(h),i.commitValidation())},d=i.displayValidation.isInvalid;return{...i,name:a,selectedValue:o,setSelectedValue:p,lastFocusedValue:m,setLastFocusedValue:c,isDisabled:e.isDisabled||!1,isReadOnly:e.isReadOnly||!1,isRequired:e.isRequired||!1,validationState:e.validationState||(d?"invalid":null),isInvalid:d}}const J=new WeakMap;function he(e,a,l){let{value:o,children:r,"aria-label":m,"aria-labelledby":c}=e;const i=e.isDisabled||a.isDisabled;let p=r!=null,d=m!=null||c!=null;!p&&!d&&console.warn("If you do not provide children, you must specify an aria-label for accessibility");let h=a.selectedValue===o,V=F=>{F.stopPropagation(),a.setSelectedValue(o)},{pressProps:k,isPressed:I}=L({isDisabled:i}),{pressProps:g,isPressed:$}=L({isDisabled:i,onPress(){a.setSelectedValue(o)}}),{focusableProps:q}=ce(y(e,{onFocus:()=>a.setLastFocusedValue(o)}),l),D=y(k,q),w=z(e,{labelable:!0}),v=-1;a.selectedValue!=null?a.selectedValue===o&&(v=0):(a.lastFocusedValue===o||a.lastFocusedValue==null)&&(v=0),i&&(v=void 0);let{name:u,descriptionId:s,errorMessageId:f,validationBehavior:n}=J.get(a);return ne(l,a.selectedValue,a.setSelectedValue),pe({validationBehavior:n},a,l),{labelProps:y(g,{onClick:F=>F.preventDefault()}),inputProps:y(w,{...D,type:"radio",name:u,tabIndex:v,disabled:i,required:a.isRequired&&n==="native",checked:h,value:o,onChange:V,"aria-describedby":[e["aria-describedby"],a.isInvalid?f:null,s].filter(Boolean).join(" ")||void 0}),isDisabled:i,isSelected:h,isPressed:I||$}}function ve(e,a){let{name:l,isReadOnly:o,isRequired:r,isDisabled:m,orientation:c="vertical",validationBehavior:i="aria"}=e,{direction:p}=A(),{isInvalid:d,validationErrors:h,validationDetails:V}=a.displayValidation,{labelProps:k,fieldProps:I,descriptionProps:g,errorMessageProps:$}=re({...e,labelElementType:"span",isInvalid:a.isInvalid,errorMessage:e.errorMessage||h}),q=z(e,{labelable:!0}),{focusWithinProps:D}=ie({onBlurWithin(u){var s;(s=e.onBlur)===null||s===void 0||s.call(e,u),a.selectedValue||a.setLastFocusedValue(null)},onFocusWithin:e.onFocus,onFocusWithinChange:e.onFocusChange}),w=u=>{let s;switch(u.key){case"ArrowRight":p==="rtl"&&c!=="vertical"?s="prev":s="next";break;case"ArrowLeft":p==="rtl"&&c!=="vertical"?s="next":s="prev";break;case"ArrowDown":s="next";break;case"ArrowUp":s="prev";break;default:return}u.preventDefault();let f=ae(u.currentTarget,{from:u.target}),n;s==="next"?(n=f.nextNode(),n||(f.currentNode=u.currentTarget,n=f.firstChild())):(n=f.previousNode(),n||(f.currentNode=u.currentTarget,n=f.lastChild())),n&&(n.focus(),a.setSelectedValue(n.value))},v=ee(l);return J.set(a,{name:v,descriptionId:g.id,errorMessageId:$.id,validationBehavior:i}),{radioGroupProps:y(q,{role:"radiogroup",onKeyDown:w,"aria-invalid":a.isInvalid||void 0,"aria-errormessage":e["aria-errormessage"],"aria-readonly":o||void 0,"aria-required":r||void 0,"aria-disabled":m||void 0,"aria-orientation":c,...I,...D}),labelProps:k,descriptionProps:g,errorMessageProps:$,isInvalid:d,validationErrors:h,validationDetails:V}}const Q=oe.createContext(null),_=C.span`
  ${S.Regular}
...
`,j=C.div`
  ...
  &[data-disabled] ${_}:after, &[data-disabled] ${_} {
    cursor: auto;
    opacity: 0.5;
  }
`,ye=C.fieldset`
...
}`,...(W=(B=x.parameters)==null?void 0:B.docs)==null?void 0:W.source}}};const ja=["Primary","WithDisabledOptions"];export{R as Primary,x as WithDisabledOptions,ja as __namedExportsOrder,_a as default};
