...
`,$=b.createContext(null),Le=fe(),B=b.forwardRef(function(o,t){const r=b.useContext($);return[o,t]=pe(Le,o,t),r?l.jsx(q,{...o,state:r,listBoxRef:t}):l.jsx(re,{content:l.jsx(ae,{...o}),children:s=>l.jsx(Ve,{...o,collection:s,listBoxRef:t})})});B.displayName="ListBox";function Ve(e){const o=be(e);return l.jsx(q,{...e,state:o})}function q(e){const{state:o,className:t,size:r="medium",listBoxRef:s}=e,{listBoxProps:a,labelProps:i}=he(e,o,s),{CollectionRenderer:d}=A(),c=F({componentClassName:"aje-listbox",className:t,size:r});return l.jsxs(l.Fragment,{children:[e.label&&l.jsx(me,{...i,children:e.label}),l.jsx(ye,{...a,...c,ref:s,children:l.jsx(de,{values:[[ce.Provider,{render:je}],[ue.Provider,{render:Se}],[$.Provider,o]],children:l.jsx(d,{collection:o.collection})})})]})}function Se(e,o,t){const r=b.useContext($),{itemProps:s,headingProps:a,groupProps:i}=Pe({heading:t.rendered,"aria-label":t["aria-label"]}),d=F({componentClassName:"aje-listbox__section",...e,children:e.title}),{CollectionBranchRenderer:c}=A();return l.jsxs(l.Fragment,{children:[t.key!==r.collection.getFirstKey()&&l.jsx(xe,{as:"li"}),l.jsxs("li",{...s,ref:o,children:[d.children&&l.jsx(Be,{...a,children:d.children}),l.jsx(_e,{...i,...d,children:l.jsx(c,{collection:r.collection,parent:t})})]})]})}function je(e,o,t){const r=b.useContext($),s=ne(o),{optionProps:a,isSelected:i}=ge({key:t.key},r,s),{focusProps:d,isFocused:c,isFocusVisible:u}=se(),f=F({componentClassName:"aje-listbox__item",...e,children:t.rendered,values:{isSelected:i,isFocused:c,isFocusVisible:u},selectors:{"data-selected":i}});return l.jsx(Fe,{...x(a,d),...f,as:e.href?"a":"li",ref:s,children:f.children})}try{B.displayName="ListBox",B.__docgenInfo={description:"",displayName:"ListBox",props:{state:{defaultValue:null,description:"",name:"state",required:!0,type:{name:"ListState<T>"}},listBoxRef:{defaultValue:null,description:"",name:"listBoxRef",required:!0,type:{name:"RefObject<HTMLUListElement>"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"RenderClassName<never>"}},style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"RenderStyle<never>"}},size:{defaultValue:null,description:"The size of the listbox",name:"size",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"medium"'},{value:'"large"'},{value:'"auto"'},{value:'"full"'}]}}}}}catch{}try{InternalListBox.displayName="InternalListBox",InternalListBox.__docgenInfo={description:"",displayName:"InternalListBox",props:{state:{defaultValue:null,description:"",name:"state",required:!0,type:{name:"ListState<T>"}},listBoxRef:{defaultValue:null,description:"",name:"listBoxRef",required:!0,type:{name:"RefObject<HTMLUListElement>"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"RenderClassName<never>"}},style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"RenderStyle<never>"}},size:{defaultValue:null,description:"The size of the listbox",name:"size",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"medium"'},{value:'"large"'},{value:'"auto"'},{value:'"full"'}]}}}}}catch{}export{L as $,B as L,Le as a,$ as b,$e as c};
