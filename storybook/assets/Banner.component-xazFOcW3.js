...
`;function y(r,n){const{variant:e="info",children:a,className:v,style:d,...u}=r,m=p({componentClassName:"aje-banner",variant:e,children:a,className:v,style:d});return o.jsx(B,{ref:n,...m,...u})}const b=i.forwardRef((r,n)=>{const{variant:e="banner",...a}=r;return o.jsx(h,{ref:n,variant:e,...a})}),l=i.forwardRef((r,n)=>{const{variant:e="inverted",...a}=r;return o.jsx(f,{ref:n,variant:e,...a})}),t=i.forwardRef(y);t.displayName="Banner";t.Content=s;s.displayName="Banner.Content";t.IconButton=b;b.displayName="Banner.IconButton";t.Button=l;l.displayName="Banner.Button";export{t as _};
