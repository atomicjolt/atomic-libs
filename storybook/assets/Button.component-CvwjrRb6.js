import{j as b}from"./jsx-runtime-CkxqCPlQ.js";import{r as f}from"./index-DJO9vBfz.js";import{$ as y,a as $}from"./useObjectRef-B0fXxeND.js";import{u as j}from"./useFocusRing-DokLxauV.js";import{u as P}from"./useRenderProps-BqJZ5b79.js";import{$ as B}from"./useButton-CctGfIuY.js";import{$ as z}from"./useLink-BfspLt2l.js";import{c as V,u as w}from"./index-B_KxbAnX.js";import{d as L}from"./styled-components.browser.esm-WCay-hu9.js";import{m as l}from"./mixins-TlkgTuSN.js";import{S as k}from"./SpinnerLoader.component-Bg5XyiJ8.js";function C(r,e){const{buttonProps:n,isPressed:a}=B(r,e),{linkProps:t,isPressed:o}=z(r,e);return r.elementType==="a"?{buttonProps:t,isPressed:o}:{buttonProps:n,isPressed:a}}const q=L.button`
  ${l.SizingX}
  ${l.Bold}
  ${l.FocusVisible(2)}
...
`,_=V(),d=f.forwardRef(function(e,n){[e,n]=w(_,e,n);const a=y(n),{isLoading:t=!1,loadingLabel:o,loadingComplete:u=!1,as:s=e.href?"a":"button",variant:v="primary",size:m="auto"}=e,{buttonProps:p,isPressed:i}=C({...e,elementType:s,"aria-label":t?o:e["aria-label"]},a),{focusProps:g,isFocusVisible:x,isFocused:h}=j(),c=P({componentClassName:"aje-btn",...e,variant:v,size:m,values:{isPressed:i,isLoading:t,isFocusVisible:x,isFocused:h},selectors:{"data-pressed":i,"data-loading":t}});return b.jsxs(q,{as:s,ref:a,...$(p,g,c),children:[t&&b.jsx(k,{isLoading:!u,placement:"absolute center"}),c.children]})});try{d.displayName="Button",d.__docgenInfo={description:"A button component that can be used to trigger actions or events",displayName:"Button",props:{as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"enum",value:[{value:'"button"'},{value:'"a"'}]}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"medium"'},{value:'"large"'},{value:'"auto"'},{value:'"full"'}]}},isLoading:{defaultValue:null,description:`When loading is true, the content will be replaced with a spinner.
