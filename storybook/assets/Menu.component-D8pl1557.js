...
`,$=y.forwardRef(function(e,n){return[e,n]=Ne(qe,e,n),c.jsx(Fe,{content:c.jsx(je,{...e}),children:a=>a.size>0&&c.jsx(Ye,{...e,collection:a,menuRef:n})})});$.displayName="Menu";function Ye(o){const{menuRef:e,className:n}=o,a=Te(o),t=z(e),{menuProps:s}=Le(o,a,t),{CollectionRenderer:r}=H();return c.jsx(Ge,{ref:t,className:me("aje-menu",n),...s,...I(o),children:c.jsx(Ee,{values:[[D.Provider,a],[Ae.Provider,{render:L}],[Ue.Provider,{render:V}]],children:c.jsx(r,{collection:o.collection})})})}function L(o,e,n){const a=y.useContext(D),{CollectionBranchRenderer:t}=H(),{itemProps:s,headingProps:r,groupProps:l}=Ve({heading:o.title,"aria-label":n["aria-label"]}),d=B({componentClassName:"aje-menu__section",...o,children:o.title});return c.jsxs(c.Fragment,{children:[n.key!==a.collection.getFirstKey()&&c.jsx(He,{as:"li"}),c.jsxs("li",{...s,...d,ref:e,children:[d.children&&c.jsx(Qe,{...r,children:d.children}),c.jsx(Je,{...l,children:c.jsx(t,{collection:a.collection,parent:n})})]})]})}const O=Ie("section",L);O.displayName="Menu.Section";$.Section=O;const V=(o,e,n)=>{const a=y.useContext(D),t=z(e),{menuItemProps:s,isSelected:r}=Oe({key:n.key,"aria-label":o["aria-label"]},a,t),{focusProps:l,isFocused:d,isFocusVisible:f}=_e(),g=B({componentClassName:"aje-menu__item",...o,children:n.rendered,values:{isSelected:r,isFocused:d,isFocusVisible:f}});return c.jsx(Xe,{...j(s,l),...g,as:o.href?"a":"li",ref:t,children:g.children})},q=De("item",V);q.displayName="Menu.Item";$.Item=q;try{$.displayName="Menu",$.__docgenInfo={description:`A Menu is a collection of items that the user can select.
