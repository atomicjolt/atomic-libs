import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{r as C,R as V}from"./index-BCtMShv3.js";import{a as I}from"./useObjectRef-B4hnndUj.js";import{$ as P,a as S}from"./useFormValidationState-CONlS5Wo.js";import{$ as B}from"./useFormValidation-CnIG3AAh.js";import{$ as _}from"./usePress-BJ4Xpz5E.js";import{$ as N,a as w}from"./useToggle-CZMQfoUA.js";import{$ as D}from"./context-z6pb9OkM.js";import{H as E}from"./Inputs.styles-DcESkT8q.js";import{g}from"./styled-components.browser.esm-DC3GK9Rn.js";import{m as y}from"./mixins-CcgEHb9c.js";import{d as x}from"./utils-DqmNl-Il.js";import{c as F,u as j}from"./index-C_lK3xe_.js";import{u as z}from"./useRenderProps-CP918x9p.js";import{R as O}from"./RequiredMarker-CwAzCIB3.js";import{M}from"./Message.component-DAaaJT6w.js";import{E as U}from"./ErrorMessage.component-DDJ9lWVu.js";function A(e,i,r){let t=P({...e,value:i.isSelected}),{isInvalid:d,validationErrors:l,validationDetails:n}=t.displayValidation,{labelProps:f,inputProps:m,isSelected:p,isPressed:s,isDisabled:c,isReadOnly:b}=N({...e,isInvalid:d},i,r);B(e,t,r);let{isIndeterminate:k,isRequired:u,validationBehavior:h="aria"}=e;C.useEffect(()=>{r.current&&(r.current.indeterminate=!!k)});let{pressProps:R}=_({isDisabled:c||b,onPress(){let{[S]:$}=e,{commitValidation:q}=$||t;q()}});return{labelProps:I(f,R),inputProps:{...m,checked:p,"aria-required":u&&h==="aria"||void 0,required:u&&h==="native"},isSelected:p,isPressed:s,isDisabled:c,isReadOnly:b,isInvalid:d,validationErrors:l,validationDetails:n}}const a=g.span`
  ${y.Regular}
