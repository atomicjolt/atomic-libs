import{j as d}from"./jsx-runtime-D_zvdyIk.js";import{r as C,R as P}from"./index-BCtMShv3.js";import{b as I}from"./useObjectRef-D2RG7rRi.js";import{$ as S,a as V}from"./useFormValidationState-CONlS5Wo.js";import{$ as B}from"./useFormValidation-BfT1egZx.js";import{$ as D}from"./usePress-CzUfyTu7.js";import{$ as j,a as w}from"./useToggle-BPntlL3P.js";import{$ as E}from"./context-z6pb9OkM.js";import{H as z}from"./Inputs.styles-DuS0VKWT.js";import{d as y}from"./styled-components.browser.esm-Y4FpNNpy.js";import{m as k}from"./mixins-XviowZ_6.js";import{d as x}from"./utils-DqmNl-Il.js";import{c as N,u as _}from"./index-CsiUWFDz.js";import{u as O}from"./useRenderProps-CP918x9p.js";import{R as F}from"./RequiredMarker-CwAzCIB3.js";import{M}from"./Message.component-BY76Ts6Z.js";import{E as H}from"./ErrorMessage.component-Dcm6zm2l.js";function L(e,r,t){let i=S({...e,value:r.isSelected}),{isInvalid:o,validationErrors:s,validationDetails:l}=i.displayValidation,{labelProps:m,inputProps:f,isSelected:b,isPressed:n,isDisabled:c,isReadOnly:h}=j({...e,isInvalid:o},r,t);B(e,i,t);let{isIndeterminate:$,isRequired:p,validationBehavior:u="aria"}=e;C.useEffect(()=>{t.current&&(t.current.indeterminate=!!$)});let{pressProps:R}=D({isDisabled:c||h,onPress(){let{[V]:v}=e,{commitValidation:q}=v||i;q()}});return{labelProps:I(m,R),inputProps:{...f,checked:b,"aria-required":p&&u==="aria"||void 0,required:p&&u==="native"},isSelected:b,isPressed:n,isDisabled:c,isReadOnly:h,isInvalid:o,validationErrors:s,validationDetails:l}}const a=y.span`
  ${k.Regular}
