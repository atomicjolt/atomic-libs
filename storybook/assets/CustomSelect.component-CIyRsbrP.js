import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as h}from"./index-DmM0KDA7.js";import"./index-CLYxO_qr.js";import{F as v}from"./FloatingFieldInputWrapper-Bj9yLkWF.js";import{d as o}from"./styled-components.browser.esm-B0S50oBn.js";import{m as b}from"./mixins-CgZ-Dp8B.js";import{F as g}from"./Dropdowns.styles-BNfmDUhX.js";import{S as l}from"./SelectField.component-0chMVHYI.js";import{u as y}from"./useRenderProps-BzxgHqRb.js";import{P as x}from"./Popover.component-B9wX7a1P.js";import{L as q}from"./ListBox.component--eojI4xZ.js";const w=o(l)`
  &.aje-select--floating {
    ${g}
  }
`;o.input`
...
@selector [data-required]`,name:"isRequired",required:!1,type:{name:"boolean"}},isInvalid:{defaultValue:null,description:"Field has an error. Should be made to look like an error.\nControls whether the value of `error` is displayed\n@selector [data-invalid]",name:"isInvalid",required:!1,type:{name:"boolean"}},name:{defaultValue:null,description:"Name of the Field",name:"name",required:!1,type:{name:"string"}},variant:{defaultValue:null,description:"",name:"variant",required:!1,type:{name:"SuggestStrings<CustomSelectVariants>"}},maxHeight:{defaultValue:{value:"height of the viewport"},description:"The maximum height of the the dropdown.",name:"maxHeight",required:!1,type:{name:"number"}},dropdownPlacement:{defaultValue:null,description:"",name:"dropdownPlacement",required:!1,type:{name:"enum",value:[{value:'"start"'},{value:'"left"'},{value:'"right"'},{value:'"top"'},{value:'"bottom"'},{value:'"bottom left"'},{value:'"bottom right"'},{value:'"bottom start"'},{value:'"bottom end"'},{value:'"top left"'},{value:'"top right"'},{value:'"top start"'},{value:'"top end"'},{value:'"left top"'},{value:'"left bottom"'},{value:'"start top"'},{value:'"start bottom"'},{value:'"right top"'},{value:'"right bottom"'},{value:'"end"'},{value:'"end top"'},{value:'"end bottom"'}]}}}}}catch{}export{r as C};
