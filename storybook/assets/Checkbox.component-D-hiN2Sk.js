import{j as d}from"./jsx-runtime-D_zvdyIk.js";import{r as C,R as P}from"./index-BCtMShv3.js";import{b as I}from"./useObjectRef-D2RG7rRi.js";import{$ as S,a as V}from"./useFormValidationState-CONlS5Wo.js";import{$ as B}from"./useFormValidation-BfT1egZx.js";import{$ as D}from"./usePress-CqXh5MnK.js";import{$ as j,a as w}from"./useToggle-iesXfB0X.js";import{$ as E}from"./context-z6pb9OkM.js";import{H as z}from"./Inputs.styles-BwIC3Pc8.js";import{g as y}from"./styled-components.browser.esm-DC3GK9Rn.js";import{m as k}from"./mixins-CcgEHb9c.js";import{d as x}from"./utils-DqmNl-Il.js";import{c as N,u as _}from"./index-CKqsTkFX.js";import{u as O}from"./useRenderProps-CP918x9p.js";import{R as F}from"./RequiredMarker-CwAzCIB3.js";import{M}from"./Message.component-C8C40eHJ.js";import{E as H}from"./ErrorMessage.component-C9Yj4uFD.js";function L(e,r,i){let t=S({...e,value:r.isSelected}),{isInvalid:o,validationErrors:s,validationDetails:l}=t.displayValidation,{labelProps:p,inputProps:m,isSelected:b,isPressed:n,isDisabled:c,isReadOnly:u}=j({...e,isInvalid:o},r,i);B(e,t,i);let{isIndeterminate:$,isRequired:f,validationBehavior:h="aria"}=e;C.useEffect(()=>{i.current&&(i.current.indeterminate=!!$)});let{pressProps:R}=D({isDisabled:c||u,onPress(){let{[V]:v}=e,{commitValidation:q}=v||t;q()}});return{labelProps:I(p,R),inputProps:{...m,checked:b,"aria-required":f&&h==="aria"||void 0,required:f&&h==="native"},isSelected:b,isPressed:n,isDisabled:c,isReadOnly:u,isInvalid:o,validationErrors:s,validationDetails:l}}const a=y.span`
  ${k.Regular}
