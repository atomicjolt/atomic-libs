...
`;B.span``;const ce=Ee(),ue=T.createContext(null);function j(n){let i=f.useRef(null);[n,i]=$e(ce,n,i);const{triggerRef:s,transitionDuration:a=300,...r}=n,e=f.useContext(ue),{tooltipProps:t}=ke({...r},e),{overlayProps:o,arrowProps:l,placement:p}=ge({targetRef:s,overlayRef:i,isOpen:e.isOpen,placement:n.placement||"top",offset:n.offset??2,crossOffset:n.crossOffset,arrowBoundaryOffset:n.arrowBoundaryOffset,shouldFlip:n.shouldFlip}),c=Oe({componentClassName:"aje-tooltip",...n}),m=U(o,t,c);return u.jsx(xe,{children:u.jsx(x,{nodeRef:i,in:e.isOpen,timeout:a,unmountOnExit:!0,children:g=>u.jsxs(He,{$transitionDuration:a,ref:i,"data-placement":p,...m,[`data-${g}`]:!0,style:{...m.style,zIndex:100001},children:[c.children,u.jsx(S,{...l})]})})})}try{j.displayName="ToolTip",j.__docgenInfo={description:"A ToolTip component displays a popup with additional information when a user hovers over or focuses on an element.",displayName:"ToolTip",props:{triggerRef:{defaultValue:null,description:`The ref for the element which the tooltip positions itself with respect to.

When used within a TooltipTrigger this is set automatically. It is only required when used standalone.`,name:"triggerRef",required:!1,type:{name:"RefObject<Element | null> | undefined"}},placement:{defaultValue:null,description:"The placement of the element with respect to its anchor element.",name:"placement",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"right"'},{value:'"left"'},{value:'"top"'},{value:'"bottom"'}]}},transitionDuration:{defaultValue:null,description:"",name:"transitionDuration",required:!1,type:{name:"number | undefined"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"RenderClassName<never>"}},style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"RenderStyle<never> | undefined"}}}}}catch{}function H(n){const{delay:i=0,closeDelay:s=0,...a}=n,r=Ie({delay:i,closeDelay:s,...a}),e=f.useRef(null),{triggerProps:t,tooltipProps:o}=je(n,r,e);return u.jsx(Se,{values:[[ue.Provider,r],[ce.Provider,{...o,triggerRef:e}]],children:u.jsx(_e,{...t,ref:e,children:n.children})})}try{H.displayName="ToolTipTrigger",H.__docgenInfo={description:"",displayName:"ToolTipTrigger",props:{className:{defaultValue:null,description:`Add classes to the root element of the component.
Refer to this for possible values: https://github.com/JedWatson/classnames#readme`,name:"className",required:!1,type:{name:"Argument | Argument[]"}}}}}catch{}function z(n){const{children:i}=n,s=T.Children.only(i),a=f.useRef(null),{focusableProps:r}=le({},a);return T.cloneElement(s,{...s.props,...r,ref:a})}try{z.displayName="ToolTipTarget",z.__docgenInfo={description:"",displayName:"ToolTipTarget",props:{}}}catch{}const ze={title:"Overlays/ToolTip",component:j,tags:["!autodocs"],parameters:{layout:"centered",cssprops:he("Tooltip")},argTypes:{size:{table:{disable:!0}},target:{table:{disable:!0}},triggerRef:{table:{disable:!0}},trigger:{description:"By default, open for both focus and hover. Can be set to only open on focus",control:"select",options:["focus",null]},delay:{control:"number",description:"Delay in milliseconds before the tooltip appears"},closeDelay:{control:"number",description:"Delay in milliseconds before the tooltip disappears"},defaultOpen:{control:"boolean",description:"Whether the tooltip should be open by default"},isDisabled:{control:"boolean",description:"Whether the tooltip should be disabled"},isOpen:{control:"boolean",description:"Control the open state of the tooltip manually"},onOpenChange:{action:"onOpenChange",description:"Callback for when the tooltip open state changes",table:{category:"Events"}},offset:{control:"number",description:"The offset of the tooltip from the trigger"}}},d={render:n=>{const{isOpen:i,defaultOpen:s,delay:a,closeDelay:r,onOpenChange:e,isDisabled:t,trigger:o,target:l,...p}=n;return u.jsxs(H,{isOpen:i,defaultOpen:s,delay:a,closeDelay:r,isDisabled:t,trigger:o,onOpenChange:e,children:[l,u.jsx(j,{...p})]})},args:{target:u.jsx(Pe,{children:"Hover Me"}),children:"This is the tooltip content",delay:0}},N={render:d.render,args:{...d.args,defaultOpen:!0}},R={...d,args:{...d.args,target:u.jsx(Ne,{label:"Label"}),placement:"bottom"}},w={...d,args:{...d.args,target:u.jsx(z,{children:u.jsx("h1",{children:"Hover Me"})})}},I={...d,args:{...d.args,target:u.jsx(me,{icon:"info",size:"large",variant:"outlined",isFocusable:!0})}};var A,G,X;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: args => {
    const {
      isOpen,
      defaultOpen,
...
}`,...(X=(G=d.parameters)==null?void 0:G.docs)==null?void 0:X.source}}};var Y,K,J;N.parameters={...N.parameters,docs:{...(Y=N.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  ...
  args: {
    ...Primary.args,
    target: <MaterialIcon icon="info" size="large" variant="outlined" isFocusable />
  }
